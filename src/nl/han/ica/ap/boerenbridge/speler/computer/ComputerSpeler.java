...
//                break;
            case "groep1":
                this.biedingAlgoritme = new nl.han.ica.ap.boerenbridge.speler.computer.algoritme.groep1.BodBepaler(this.kaartteller, this.typeteller);
                break;
            case "groep2":
                this.biedingAlgoritme = new nl.han.ica.ap.boerenbridge.speler.computer.algoritme.groep2.BodBepaler(this.kaartteller, this.typeteller);
                break;
            default:
...
//                break;
            case "groep1":
                this.kaartAlgoritme = new nl.han.ica.ap.boerenbridge.speler.computer.algoritme.groep1.KaartBepaler(this.kaartteller, this.typeteller);
                break;
            case "groep2":
                this.kaartAlgoritme = new nl.han.ica.ap.boerenbridge.speler.computer.algoritme.groep2.KaartBepaler(this.kaartteller, this.typeteller);
                break;
            default:
